...
[![Release
Version](https://img.shields.io/github/release/jefferislab/RANN.svg)](https://github.com/jefferislab/RANN/releases/latest)
...
[![Codecov test
coverage](https://codecov.io/gh/jefferislab/RANN/graph/badge.svg)](https://app.codecov.io/gh/jefferislab/RANN)
...
For the Manhattan (L1) metric, install the
[RANN1](https://github.com/jefferislab/RANN/tree/master-L1) package.

For further details on the underlying ANN library, see
...
The recommendation is to install the released version from
[CRAN](https://cran.r-project.org/) by doing:
...
You can, however, use the **remotes** package to install the development
version:
...
- submit suggestions and bug-reports at:
  <https://github.com/jefferislab/RANN/issues>
...
see [inst/COPYRIGHT](https://jefferislab.github.io/RANN/inst/COPYRIGHT)
and [DESCRIPTION](https://jefferislab.github.io/RANN/DESCRIPTION) files
